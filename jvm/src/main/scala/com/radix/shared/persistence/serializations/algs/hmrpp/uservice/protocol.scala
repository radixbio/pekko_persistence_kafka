...
object protocol {
  ...
  case class HMRPPUnweighted[T: Encoder: Decoder: SchemaFor: ClassTag](
    graph: Graph[T],
  ...
  object HMRPPUnweighted {
    ...
    ): AvroSerializer[HMRPPUnweighted[T]] = new AvroSerializer[HMRPPUnweighted[T]]
  }
  case class SingleHMRPPWalkUnweighted[T: Encoder: Decoder: SchemaFor: ClassTag](
    graph: Graph[T],
    replyTo: ActorRef[HMRPPResponse[T]]
  ) extends HMRPPRequest {
    val ser = implicitly[Encoder[T]]
  ...
  object SingleHMRPPWalkUnweighted {
    implicit def avro[T: SchemaFor: ClassTag: Decoder: Encoder](
      implicit A: ExtendedActorSystem
    ): AvroSerializer[SingleHMRPPWalkUnweighted[T]] =
  ...
  case class HMRPPProblem[T: Encoder: Decoder: SchemaFor: ClassTag](
    graph: Graph[T],
    replyTo: ActorRef[HMRPPResponse[T]]
  ) extends HMRPPRequest {
    val ser = implicitly[Encoder[T]]
  ...
  object HMRPPProblem {
    implicit def avro[T: SchemaFor: ClassTag: Decoder: Encoder](
      implicit A: ExtendedActorSystem
    ): AvroSerializer[HMRPPProblem[T]] = new AvroSerializer[HMRPPProblem[T]]
  }
  case class SingleHMRPPWalkProblem[T: Encoder: Decoder: SchemaFor: ClassTag](
    graph: Graph[T],
    replyTo: ActorRef[HMRPPResponse[T]]
  ) extends HMRPPRequest {
    val ser = implicitly[Encoder[T]]
  ...
  object SingleHMRPPWalkProblem {
    implicit def avro[T: SchemaFor: ClassTag: Decoder: Encoder](
      implicit A: ExtendedActorSystem
    ): AvroSerializer[SingleHMRPPWalkProblem[T]] =
