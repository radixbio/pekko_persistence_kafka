scala_library(
    ...
    exports = [
        ...
        "//shared/persistence/src/main/scala/serializations/utils/pingpong2:pingpong2-serializations",
        ...
        "//shared/persistence/src/main/scala/serializations/utils/scheduler2:scheduler2-serialization",
